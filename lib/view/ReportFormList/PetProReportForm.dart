...
class PetProReportForm extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    PetProReportFormStage reportPageStage = new PetProReportFormStage();
...
class PetProReportFormStage extends State<PetProReportForm> {
        ...
        leading: IconButton(
            ...
            onPressed: () {
              Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (context) => PetProReportForm(),
              ));
            }),
        title: Container(
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => PetProProfileApp(),
                    ));
                  },
